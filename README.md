...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_control_tower"></a> [control\_tower](#module\_control\_tower) | git@github.com:aws-ia/terraform-aws-control_tower_account_factory | n/a |
...
| <a name="input_aft_management_account_id"></a> [aft\_management\_account\_id](#input\_aft\_management\_account\_id) | AFT Management Account ID | `string` | `""` | no |
...
| <a name="input_audit_account_id"></a> [audit\_account\_id](#input\_audit\_account\_id) | Audit Account Id | `string` | `""` | no |
...
| <a name="input_ct_home_region"></a> [ct\_home\_region](#input\_ct\_home\_region) | The region from which this module will be executed. This MUST be the same region as Control Tower is deployed. | `string` | `""` | no |
| <a name="input_ct_management_account_id"></a> [ct\_management\_account\_id](#input\_ct\_management\_account\_id) | Control Tower Management Account Id | `string` | `""` | no |
...
| <a name="input_log_archive_account_id"></a> [log\_archive\_account\_id](#input\_log\_archive\_account\_id) | Log Archive Account Id | `string` | `""` | no |
...
| <a name="input_profile"></a> [profile](#input\_profile) | AWS Profile to authenticate using | `string` | `"default"` | no |
